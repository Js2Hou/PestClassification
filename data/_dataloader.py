...
class Pest:
    ...
    def dataset():
        ...
        """
        transform = transforms.Compose([transforms.Resize(Pest.img_size), transforms.ToTensor(),
                                        transforms.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225])])
        dataset_ = ImageFolder(Pest.train_path, transform=transform)
        return dataset_
    ...
    def testdata():
        ...
        for name_ in names:
            ...
            img = cv2.resize(img, Pest.img_size)
